...
DEFAULT_TF2_CPU_IMAGE = "determinedai/environments-dev:py-3.8-pytorch-1.10-tf-2.8-cpu-251fac9"
DEFAULT_TF1_GPU_IMAGE = "determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-3e933ea"
DEFAULT_TF2_GPU_IMAGE = "determinedai/environments-dev:cuda-11.3-pytorch-1.10-tf-2.8-gpu-251fac9"
